...
const DEFAULT_CONFIG: Pengaturan = {
  ...
  NIP_Guru: "-",
  Pemerintah: "YAYASAN TUNAS MEDIA",
  Nama_Sekolah: "SMK TUNAS MEDIA",
  Alamat_Sekolah: "Jl. Pendidikan SMK Tunas Media",
  Nama_Kepsek: "Kepala Sekolah",
  NIP_Kepsek: "-",
  Tempat_Tanda_Tangan: "Kota Pendidikan",
    ...
    const seedInitialData = async () => {
      ...
      if (siswaList.length === 0 && isConnected) {
        const sampleSiswa: Siswa[] = [
          { id: "1001", nisn: "0012345678", nama: "Ahmad Fulan", kelas: "X TKJ 1" },
          { id: "1002", nisn: "0012345679", nama: "Siti Aminah", kelas: "X TKJ 1" },
          { id: "1003", nisn: "0012345680", nama: "Budi Pratama", kelas: "X TKJ 2" },
          { id: "1004", nisn: "0012345681", nama: "Rizky Febrian", kelas: "X TKJ 2" }
        ];
      ...
      if (mapelList.length === 0 && isConnected) {
        const sampleMapel: Mapel[] = [
          ...
          { id: "m4", namaMapel: "Dasar-Dasar Kejuruan", semester: "Ganjil", tahunAjaran: "2026/2027" }
        ];
      ...
      if (jadwalList.length === 0 && isConnected) {
        const sampleJadwal: Jadwal[] = [
          { id: "j1", hari: "Senin", jam: "07:30 - 09:00", kelas: "X TKJ 1", mapel: "Informatika" },
          { id: "j2", hari: "Selasa", jam: "09:15 - 10:45", kelas: "X TKJ 2", mapel: "Informatika" }
        ];
